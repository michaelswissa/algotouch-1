  ...
  return <Card className="hover-glow mx-0">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          <span className="text-center">ניתוח נתונים</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <div className="flex justify-between">
            <span className="text-slate-50">סך עסקאות:</span>
            <span className="font-medium">{stats?.totalTrades || 0}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-50">רווח/הפסד:</span>
          ...
          <div className="flex justify-between">
            <span className="text-slate-50">נטו:</span>
