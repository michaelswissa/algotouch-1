...
const PaymentSectionHeader: React.FC<PaymentSectionHeaderProps> = ({ 
  ...
  return (
    <CardHeader className="relative bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 pt-8 pb-5 border-b border-primary/20" dir="rtl">
      {/* Background effects */}
      ...
      <div className="relative">
        <div className="flex flex-col gap-1 mb-5 animate-fade-in">
          ...
          <p className="text-cyan-300 text-sm mt-2 text-right italic animate-pulse-subtle">
