            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              <div className="relative w-full max-w-xs mx-auto mt-2">
                <TabsList className="grid grid-cols-2 w-full rounded-full border border-border/20 p-1 bg-muted/30 backdrop-blur-md overflow-hidden">
                  {/* Switch track - reordered for RTL with login first, signup second */}
                  <div 
                  ...
                  {/* Reordered tab triggers - Login first, Signup second */}
                  <TabsTrigger 
                    value="login" 
                    className="rounded-full py-1.5 px-3 relative z-10 transition-colors duration-300 font-medium
