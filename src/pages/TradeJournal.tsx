      ...
      <div className="tradervue-container py-6">
        ...
        <div className="mb-8 animate-fade-in">
          ...
          <ScrollArea className="w-full whitespace-nowrap">
            <div className="flex space-x-4 pb-4" dir="ltr">
              {tradeNotes.map((note) => (
                <Card key={note.id} className="inline-block w-[300px] hover-scale hover-glow">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground whitespace-normal line-clamp-2 mb-3">
                      {note.excerpt}
                    </p>
        ...
        <div className="mb-8 animate-fade-in bg-white/50 dark:bg-white/5 p-4 rounded-xl border border-white/30 dark:border-white/5 shadow-sm backdrop-blur-sm" style={{ animationDelay: "0.1s" }}>
          <TradeFilters />
        </div>
        
        <div className="mb-8 animate-fade-in glass-card-2025 p-4 rounded-xl" style={{ animationDelay: "0.2s" }}>
          <PerformanceMetrics />
        </div>
        
        <div className="animate-fade-in bg-white/50 dark:bg-white/5 p-4 rounded-xl border border-white/30 dark:border-white/5 shadow-sm backdrop-blur-sm" style={{ animationDelay: "0.3s" }}>
          <TradeList />
        </div>
      </div>
    </Layout>
